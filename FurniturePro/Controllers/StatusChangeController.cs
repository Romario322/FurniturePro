...
public class StatusChangeController : ControllerBase
{
    ...
    public async Task<List<StatusChangeDTO>> GetAfterDate(string dateTime, CancellationToken ct = default) =>
        await _statusChangeService.GetAfterDateAsync(dateTime, ct);
