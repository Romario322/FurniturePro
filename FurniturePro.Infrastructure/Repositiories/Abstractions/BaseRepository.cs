...
namespace FurniturePro.Infrastructure.Repositiories.Abstractions;
...
where TDbContext : DbContext
{
    ...
    public virtual async Task<List<TEntity>> GetAfterDateAsync(DateTime dateTime, CancellationToken ct = default)
    {
        return await _dbSet.AsNoTracking().Where(ent => ent.UpdateDate > dateTime).ToListAsync(ct);
    }
