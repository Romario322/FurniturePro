...
public class CategoryService : ICategoryService
{
    ...
    public async Task<List<CategoryDTO>> GetAfterDateAsync(string dateTime, CancellationToken ct = default)
    {
        var entities = await _categoryRepository.GetAfterDateAsync(dateTime, ct);
