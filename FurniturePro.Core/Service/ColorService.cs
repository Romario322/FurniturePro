...
public class ColorService : IColorService
{
    ...
    public async Task<List<ColorDTO>> GetAfterDateAsync(string dateTime, CancellationToken ct = default)
    {
        var entities = await _colorRepository.GetAfterDateAsync(dateTime, ct);
