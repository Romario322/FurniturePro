...
public class ClientService : BaseService<Client, int, ClientDto, CreateClientDto, UpdateClientDto>, IClientService
{
    public ClientService(IClientRepository repository, ICurrentUserService currentUserService, IDeletedIdRepository deletedIdRepository, IMapper mapper)
